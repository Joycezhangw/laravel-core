...
namespace LanDao\LaravelCore\Repositories;

use Illuminate\Container\Container as Application;
use Illuminate\Database\Eloquent\Model;
use Illuminate\Database\QueryException;
use Illuminate\Support\Facades\DB;
use LanDao\LaravelCore\Exceptions\RepositoryException;
use LanDao\LaravelCore\Repositories\Interfaces\BaseInterface;
use Closure;
